...
var CheckoutPage = (function () {
    function CheckoutPage(nav, navParams, storage, afd, ordersService, loadingCtrl, toastCtrl) {
        var _this = this;
        this.nav = nav;
        this.navParams = navParams;
        this.storage = storage;
    ...
    CheckoutPage.prototype.send = function () {
        ...
        setTimeout(function () {
            ...
            _this.afd.list('restaurants/' + sessionStorage.getItem('restaurant') + '/orders').update(JSON.stringify(_this.orderNumber), {
